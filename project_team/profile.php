            ...
            <div class="text-[20px] font-semibold">
                ...
                <form id="myForm" class="space-y-4">
                    ...
                    <div class="flex">
                      ...
                      <!-- Cancel Button -->
                      <button id="logoutBtn" type="button" class="px-4 py-2 bg-red-500 text-white rounded-md text-[15px] ml-2"><i class="fa-solid fa-right-from-bracket"></i> Logout</button>
                    </div>
                  </form>
                </div>
            </div>
