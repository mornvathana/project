<footer class="mt-60">
        ...
        <div
            class="top-footer bg-[#144194] p-5 sm:p-10 w-[100%] flex-col md:flex-row flex justify-between items-start md:items-center space-y-3 md:space-y-0">
            <div class="tittle space-y-3">
                <h1
                    class="font-bold font-[Montserrat,hanuman,Sans-serif] text-[23px] sm:text-2xl text-[#fff] shadow-black">
                    Stay Updated With Our Latest Price & Offers!</h1>
                <p
                    class="font-[Poppins,hanuman,Sans-serif] text-[13px] sm:text-[15px] md:text-[16px] lg:text-[16px] xl:text-[13px] 2xl:text-[13px] text-[#fff] font-medium">
        ...
        <div class="bottom-footer bg-[#06090c] w-[100%] py-2">
            ...
            <div class="contact p-5 sm:p-5 flex flex-col md:flex-row justify-between gap-5">
                <div class="text-[#fff] w-[100%] md:w-[35%]">
                    ...
                    <div
                        ...
                        <i class="fa-solid fa-phone"></i> 0963904112
                    </div>
                    <div
                        class="email font-[Poppins,hanuman,Sans-serif] text-[13px] sm:text-[14px] md:text-[14px] lg:text-[14px] xl:text-[14px] 2xl:text-[14px] text-[#fff] font-medium mt-3">
                        <i class="fa-solid fa-envelope"></i> mrounit83@gmail.com
                    </div>
                </div>
                ...
                <div class="text-[#fff] w-[100%] md:w-[23%]">
                    <h1
                        class="font-bold font-[Montserrat,hanuman,Sans-serif] text-[23px] sm:text-2xl text-[#fff] shadow-black">
                        Contact Us</h1>
                    <div
                        class="messenger font-[Poppins,hanuman,Sans-serif] text-[13px] sm:text-[14px] md:text-[14px] lg:text-[14px] xl:text-[14px] 2xl:text-[14px] text-[#fff] font-medium mt-5">
                        <a href="#"><i class="fa-brands fa-facebook-messenger"></i> Chat On Messenger</a>
                    </div>
                    <div
                        class="telegram font-[Poppins,hanuman,Sans-serif] text-[13px] sm:text-[14px] md:text-[14px] lg:text-[14px] xl:text-[14px] 2xl:text-[14px] text-[#fff] font-medium mt-3">
                        <a href="#"><i class="fa-brands fa-telegram"></i> Chat On Telegram</a>
                    </div>
                    <div
                        class="tik tok font-[Poppins,hanuman,Sans-serif] text-[13px] sm:text-[14px] md:text-[14px] lg:text-[14px] xl:text-[14px] 2xl:text-[14px] text-[#fff] font-medium mt-3">
                        <a href="#"><i class="fa-brands fa-tiktok"></i> Chat On Tik Tok</a>
                    </div>
                </div>
            </div>
  ...
  <div class="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3">
    ...
    <div id="menuItems" class="flex flex-col items-end space-y-3 transform scale-0 opacity-0 transition-all duration-300 origin-bottom">
      ...
      <div class="flex items-center space-x-2">
        ...
        <a href="tel:+8850963904112">
        <button class="bg-blue-600 hover:bg-green-700 p-3 rounded-full shadow-lg text-white">
      ...
      <!-- Live chat -->
      <div class="flex items-center space-x-2">
        <span class="bg-gray-700 text-white text-sm px-2 py-1 rounded">Telegram</span>
        <a href="">
        <button class="bg-blue-600 hover:bg-green-700 p-3 rounded-full shadow-lg text-white">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <!-- Send email -->
      <div class="flex items-center space-x-2" id="user-menu-button1"
            aria-expanded="false"
    ...
    <!-- start chat -->
    <div class="z-50 hidden rounded-lg my-4 text-base w-[400px] bg-[#f0f2f5] list-none bg-[#f3f5f7] divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                id="user-dropdown">
                <!-- chat area -->
                ...
                <div id = "chatarea">
                    <div class = "w-full h-[35px] px-2 gap-2 grid grid-cols-[25px_1fr] bg-[#ffffff] flex justify-start items-center">
                        ...
                        <div class = "flex gap-2 justify-start items-center">
                            ...
                            <span class = "font-blod text-sm">Live Chat En lin smart phone shop</span>
                        </div>
                    </div>
                    <ul class="py-2 overflow-y-auto" aria-labelledby="user-menu-button">
                    <li>
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                        <div class="h-[200px] overflow-y-auto flex flex-col-reverse p-2 space-y-2 bg-white rounded" id="displayChatMessage">
                ...
                <div>
                    ...
                    <div class="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                        ...
                        <input type = "hidden" id = "userId" value = "<?= $id ?>"/>
                            <button class="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600" id = "sendChat">
    ...
    <!-- Toggle Button -->
    <button id="toggleMenuBtn" class="bg-blue-500 text-white p-4 rounded-full shadow-lg hover:bg-gray-800 transition w-12 h-12 flex items-center justify-center">
      <!-- Icon changes here -->
      <span id="menuIcon" class="text-2xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
