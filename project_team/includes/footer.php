<footer class="mt-60">
    ...
    <script>
        ...
        fetch('get_products.php?q=' + encodeURIComponent(searchTerm))
            ...
            .then(products => {
                ...
                products.forEach(product => {
                    ...
                    <a href="pro-detail.php" class="flex items-center space-x-3">
                        <img src="https://angkormeas.com/wp-content/uploads/2025/03/nova-13-pro-green-.jpg?v=1742198861" alt="${product.name}" 
                            class="w-10 h-10 object-cover rounded-md">
                        <div class="flex-1 min-w-0">
                            <div class="font-medium truncate">${product.name}</div>
                            <div class="text-xs text-gray-500">smartphone</div>
                        </div>
                    </a>
                    `;
                    ...
                    autocompleteResults.appendChild(productElement);
                });
