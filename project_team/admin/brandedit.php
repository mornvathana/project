        ...
        <div class = "h-full px-2 py-2 bg-blue-50">
            <div class = "w-full bg-[#ffffff] h-[100vh] rounded-md p-5">
                <div class = "w-full h-[10%] flex justify-between items-center">
                    <div>
                        <h1 class = "font-medium"><?php echo $text['editbrand']?></h1>
                    </div>
                    <div>
                ...
                <div class="w-full h-[70%] mt-5">
                   <?php
                    ...
                    <form action="code.php" method = "post" enctype = "multipart/form-data">
                        ...
                        <button type = "submit" class = "bg-blue-500 text-white px-2 py-1 font-medium rounded-md" name = "edit_brand"><?php echo $text['submit']?></button>
                        </div>
                    </form>
                    <?php
                    }
