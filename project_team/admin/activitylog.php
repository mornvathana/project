...
<div class="h-full px-2 py-2 ">
    <div class="w-full bg-[#f3f5f7] rounded-md p-5">
        ...
        <div class = "w-full h-[30px] mt-5 flex justify-between items-center">
            <div>
                <form class="max-w-md mx-auto w-[400px]">   
            ...
            <div class = "flex">
                ...
                <select id="page_num" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-7 px-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option selected value = "0"><?php echo $text['page']?></option>
                    <?php
                        $user = getAll("users");
                        if($user->num_rows > 0){
            ...
            <table class="text-center w-full table-auto">
                <thead class = "bg-[#f6f8fa]">
                    <tr>
                        ...
                        <th width="100" class="py-2 text-[11px] md:text-[13px] text-[#646a7a] shadow-b border-gray-900 font-medium"><?php echo $text['action']?></th>
