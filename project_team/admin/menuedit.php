        ...
        <div class = "h-full px-2 py-2 bg-blue-50">
            <div class = "w-full bg-[#ffffff] h-[100vh] rounded-md p-5">
                <div class = "w-full h-[10%] flex justify-between items-center">
                    ...
                    <div>
                        <a href = "menu.php" class = "bg-blue-500 text-[12px] text-white px-2 py-1 font-medium rounded-md"><i class="fa-solid fa-arrow-left pr-1"></i><?php echo $text['back']?></a>
                    </div>
                </div>
                    ...
                    <form action="code.php" method = "post" enctype = "multipart/form-data">
                        ...
                        <label for="name" class = "block py-1 text-[13px]">><?php echo $text['uploads']?><span class = "text-red-500">*</span></label>
                           ...
                           <div class = "w-[50%] flex justify-center items-center relative">
                                ...
                                <label for="profile_image" class = "absolute text-sm "><?php echo $text['select']?> <i class="fa-solid fa-image"></i></label>
                           </div> 
                        </div>
                        </div>
                        <div class="w-full mt-3 flex justify-end items-center pr-5">
                        <button type = "submit" class = "bg-blue-500 text-white px-2 py-1 font-medium rounded-md" name = "edit_product"><?php echo $text['submit']?></button>
                        </div>
                    </form>
                    <?php
                    }
