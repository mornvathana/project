        ...
        <div class = "h-full px-2 py-2">
            <div class = "w-full bg-[#f3f5f7] h-[100vh] rounded-md p-5">
                <div class = "w-full h-[10%] flex justify-between items-center">
                    <div>
                        <h1 class = "font-medium"><?php echo $text['createproduct']?></h1>
                    </div>
                    <div>
                ...
                <div class="w-full h-[85%] mt-5 bg-[#ffffff] p-4 rounded-md">
                    <form action="code.php" method = "post" enctype = "multipart/form-data">
                        ...
                        <button type = "submit" class = "bg-blue-500 text-white px-2 py-1 font-medium rounded-md" name = "add_product"><?php echo $text['submit']?></button>
                        </div>
                    </form>
                </div>
            </div>
