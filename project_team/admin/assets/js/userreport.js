                ...
                success: function (data) {
                    ...
                    if(data.length > 0){
                        ...
                        for(i in data){
                            ...
                            <td class="text-[11px] shadow-style bg-[#ffffff] md:text-[13px] py-1"><a href= "../action/invoice.php?orderid=${item.id}&userid=${item.userId}" target = "_blank"><i class="fas fa-download text-green-500 rounded-sm p-2 cursor-pointer bg-green-100"></i></a></td>
                            <td class="text-[11px] shadow-style bg-[#ffffff] md:text-[13px] py-1"><a href= "../action/smallinvoice.php?orderid=${item.id}&userid=${item.userId}" target = "_blank"><i class="fas fa-download text-green-500 rounded-sm p-2 cursor-pointer bg-green-100"></i></a></td>
                            </tr>`;
                        }
