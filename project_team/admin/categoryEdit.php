        ...
        <div class = "h-full px-2 py-2 bg-blue-50">
            <div class = "box-circle">  
                <?php
                    if(isset($_GET['id'])){
                        $id = $_GET['id'];
                        $category = getById("category_db",$id);
                        if($category->num_rows > 0){
                        $cate_edit = mysqli_fetch_array($category);
                        ?>
                    ...
                    <div class = "frm">
                        ...
                        <input type="text" name = "cate_name" value = "<?= $cate_edit['name']?>" placeholder="Enter your name...">
                        <label for="">Small Description</label>
                        <input type="text" name = "cate_small_des" value = "<?= $cate_edit['small_des']?>" placeholder="Enter your small description...">
                    </div>
                    <div class = "frm">
                     ...
                     ?>
                        ...
                        <label for="">Ram</label>
                        <input type="text" name = "cate_ram" value = "<?= $cate_edit['ram']?>" placeholder="Enter your Ram...">
                    </div>
                    <div class = "frm">
                        <label for="">Sell Price</label>
                        <input type="text" name = "cate_sell_price" value = "<?= $cate_edit['sell_price']?>" placeholder="Sell Price...">
                    ...
                    <div class = "frm">
                        ...
                        <input type="file" classs = "cate_de_image" >
                    </div>
                    <div class = "frm">
                        <p>LAUNCH</p>
                    ...
                    <input type="submit" value = "Update" name = "category_update" class = "bg-blue-500 font-bold px-5 text-white rounded-md">
                    </form>
                            <?php
                        }
                    }
